        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mb-6 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="text-xs text-gray-600 space-y-1">
              <p>
                <strong>Admin:</strong> admin@Medicalvance Platform.com
              </p>
              <p>
                <strong>Doctor:</strong> doctor@Medicalvance Platform.com
              </p>
              <p>
                <strong>Patient:</strong> patient@Medicalvance Platform.com
              </p>
              <p>

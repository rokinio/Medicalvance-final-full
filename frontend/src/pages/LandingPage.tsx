...
const LandingPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* بخش بالایی با پس‌زمینه گرادیانت */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center py-20">
            ...
            <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
              ...
              healthcare professionals. Join our community for secure,
              professional medical consultations and care.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow border-2 border-transparent hover:border-blue-200">
                ...
                <p className="text-gray-600 mb-8">
                  Find qualified doctors, book consultations, and manage your
                  healthcare journey securely.
                </p>
                <Link
                  to="/register/patient"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              ...
              consultations with verified healthcare providers.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 px-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                All doctors are thoroughly verified and approved by our medical
                board.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Comprehensive care management with secure patient-doctor
                communication.
              </p>
            </div>
            <div className="text-center">
